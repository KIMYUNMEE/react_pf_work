...
function Main() {
    ...
    <figure className="visual">
      ...
      <div>
      <section className="contents_about">
       <div className="inner">
      ...
      <div>
 <section className="contents_about02">
        <div className="inner">
            <h2>Services</h2>
                    <div className="wrap01">
                       <ul>
      ...
      <div>
       <section className="contents_about03">
        <div className="inner">
            <h2>Process</h2>
                    <div className="wrap01">
      ...
      <div>
        <section className="contents_about04">
        <div className="inner">
            <h2>Our team</h2>
            <div className="wrap01">
               <ul>
      ...
      <div>
       <section className="contents_about05">
        <div className="inner">
            <h2>NEWS</h2>
